...
class Login(QMainWindow):
    def __init__(self):
        ...
        rfid_log_btn = QPushButton("Login Using Card",self)
        rfid_log_btn.setStyleSheet("QPushButton { font-size: 40px; background-color:  #699913; font-family: Roboto;font-weight: 900; font-style: normal; color: white;  border-radius: 20px; }" "QPushButton:pressed { background-color: #0E7470; color:  #FFFFFF;  }" )
        rfid_log_btn.setGeometry(300, 720, 600, 100)
        rfid_log_btn.clicked.connect(self.clicked_RFID)
        ...
        reg_btn.setGeometry(300, 840, 600, 100)
...
# Open serial connection to Arduino
        ...
        while True:
            ...
            # Check if received UID matches authorized UI
    ...
    def detect_rfid(self):
        user_rfid = str( '04 2F 74 3A 7B 46 80 04 2F 74 3A 7B 46 80')
